  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg p-5">
      ...
      <p className="text-xs text-gray-500 mb-4">
        Fill in your details to get the Legacy by Gaurs brochure
      </p>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-[#c8952a] hover:bg-[#b07d1f] text-white text-xs font-semibold tracking-widest uppercase px-4 py-3 rounded-md transition-all duration-300 disabled:opacity-70"
        >
