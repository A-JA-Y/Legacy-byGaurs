...
export const metadata: Metadata = pageMetadata("configurations");
  ...
  return (
    <>
      <PageBanner
        ...
        subtitle="Magnificent 4 BHK condominiums from 3,510 to 4,765 sq. ft. across four towers, plus 20 lavish Legacy Villas at Jaypee Greens, Greater Noida."
        image={livingArea}
      />
      <ModalWrapper />
      ...
      <section className="w-full bg-white py-16 px-6">
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          {/* Towers */}
          <div>
            <h2 data-reveal="up" className="text-2xl font-semibold text-gray-900 mb-6">
              Four Iconic Towers
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8" data-stagger="100">
              {towers.map((t, i) => (
                <div key={t.name} data-reveal="up">
                <div
                  data-tilt
                  className="relative h-full overflow-hidden bg-[#1A2352] text-center py-9 px-3 rounded-xl"
                >
                  <span aria-hidden="true" className="absolute -right-2 -bottom-6 text-[5.5rem] font-bold leading-none text-white/[0.04] select-none" style={{ fontFamily: "var(--font-work-sans)" }}>
                    0{i + 1}
                  </span>
                  <p className="text-lg font-bold text-shimmer">{t.name}</p>
            ...
            <p data-reveal="up" className="text-sm text-gray-600">
          ...
          <div>
            ...
            <p data-reveal="up" className="mb-6 text-gray-700">
            ...
            <div data-reveal="up" className="overflow-x-auto rounded-lg border border-[#e5dcc5] shadow-sm mb-4">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-6">
              <div data-reveal="left" data-tilt className="bg-[#FAF8F4] p-6 rounded-lg border border-[#e5dcc5]">
              ...
              <div data-reveal="right" data-tilt className="bg-[#FAF8F4] p-6 rounded-lg border border-[#e5dcc5]">
                <h3 className="text-base font-bold text-gray-900 mb-2">
            ...
            <div className="flex flex-wrap gap-2" data-stagger="50">
              {villas.levels.map((l) => (
                <span
                  key={l}
                  data-reveal="zoom"
            ...
            <p className="text-sm text-gray-600 mt-6">
              <Link href="/floor-plans" className="link-draw text-[#c8922a] font-semibold">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5" data-stagger="70">
              {specifications.map((s) => (
                <div
                  key={s.title}
                  data-reveal="up"
                  className="card-lift bg-white p-6 rounded-lg border border-[#e5dcc5] hover:border-[#DCA54A]/60"
                >
          ...
          <div className="text-center pt-8 border-t border-[#e5dcc5]">
            <Link
              href="/contact-us"
              data-magnetic
              className="btn-shine inline-block bg-[#DCA54A] hover:bg-[#C08F3C] text-white text-base font-semibold tracking-widest uppercase px-10 py-4 rounded-md transition-colors shadow-md"
            >
